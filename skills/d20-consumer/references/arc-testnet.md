...
Chain ID: **5042002**. Snapshot copied from the deployment manifest on **2026-09-17**.
...
| Epoch registry | `0xD20Da00B47A7cD2211dC4683E306913b05903756` | `0xD20dA0311C56f92d841d5c74F15ec691e0cfB960` |
...
Contract source commit recorded by the manifest for this snapshot: `640b60cb992a7e3add1efe8e7b392341732ea004`, with the registry upgraded to `96cc722a8c7e1b7f2389e162fe96fb3c314de47f` (variable source catalogs). Match the installed SDK's `PROTOCOL-PROVENANCE.json` to the deployment in use. A stable proxy address does not establish unchanged implementation behavior.
